...
export function PortfolioCard({ item }) {
  ...
  return (
    <div className="group relative aspect-[9/16] w-full rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 ease-in-out bg-neutral-800">
